...
.directive('eventNotes', function () {
  return {
    restrict: "E",
    templateUrl: "app/components/event/event.notes.tmpl.html"
  };
}) // END OF DIRECTVE
...
.directive('eventDuration', function () {
  return {
    restrict: "E",
    templateUrl: "app/components/event/event.duration.tmpl.html"
  };
}) // END OF DIRECTVE
...
.directive('eventLinks', function () {
  return {
    restrict: "E",
    templateUrl: "app/components/event/event.links.tmpl.html"
  };
}) // END OF DIRECTVE
...
.directive('eventDeleteEdit', function () {
  return {
    restrict: "E",
    templateUrl: "app/components/event/event.delete.edit.tmpl.html"
  };
}) // END OF DIRECTVE

.directive('eventGuestlist', function () {
  return {
    restrict: "E",
    templateUrl: "app/components/event/event.guestlist.tmpl.html"
  };
}) // END OF DIRECTVE

.directive('eventGuestlistEdit', function () {
  return {
    restrict: "E",
    templateUrl: "app/components/event/event.guestlist.edit.tmpl.html"
  };
}) // END OF DIRECTVE
